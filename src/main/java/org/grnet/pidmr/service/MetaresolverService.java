...
//        var parameters = new Proxy.Parameters();
//
//        parameters.hdl = "21.T11973/MR@urn:nbn:de:hbz:6-85659524771?resource";
//        parameters.clear = "resolve";
//
//
//        var response = proxy.sendMultipart(parameters);
//
//        return response.header.request;
    }
